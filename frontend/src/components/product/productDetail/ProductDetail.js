...
const ProductDetail = () => {
    ...
    const {isLoading, isError, message,product} = useSelector((state) => state.product);
            ...
            {product && (
                <div className='detail'>
                    <Card cardClass="group">
                        {product?.image ? (
                            <img src={product.image.filePath} alt={product.image.fileName} width="500" height="500"/>
                        ):(
                    ...
                    <br/>
                    <code className='--color-dark'>Last updated at: {product.updatedAt.toLocaleString("en-US")}</code>
